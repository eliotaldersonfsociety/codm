...
export default function DeltaForcePage() {
  ...
  const handleAddToCart = (duration: string, price: number) => {
    addItem({
      id: `delta-force-${duration}-${Date.now()}`,
      ...
      <section className="relative pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-400">Gain the competitive edge with our premium Delta Force cheat packages. Available for Android only</p>
          </div>
