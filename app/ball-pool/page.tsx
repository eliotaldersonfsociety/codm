...
export default function BallPoolPage() {
  const { addItem, openCart } = useCartStore()

  const handleAddToCart = (duration: string, price: number) => {
    addItem({
      id: `ball-pool-${duration}-${Date.now()}`,
      name: "Ball Pool Cheats",
      game: "Ball Pool",
      duration,
      price,
    })
      ...
      <section className="relative pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-400">Gain the competitive edge with our premium Ball Pool cheat packages. Available for Android and iOS</p>
          </div>
