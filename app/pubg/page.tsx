      ...
      <section className="relative pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-400">Gain the competitive edge with our premium PUBG cheat packages. Available for iOS and Android (no root required)</p>
          </div>
