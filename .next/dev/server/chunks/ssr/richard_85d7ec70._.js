...
"[project]/richard/app/actions/data:2e05ee [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$richard$2f$app$2f$actions$2f$data$3a$2e05ee__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/richard/app/actions/data:2e05ee [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$richard$2f$app$2f$actions$2f$data$3a$2e05ee__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["loginUser"])(formData);
        if (result.error) {
            alert(result.error);
            return;
        }
...
//# sourceMappingURL=richard_85d7ec70._.js.map