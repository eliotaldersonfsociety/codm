...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$richard$2f$app$2f$actions$2f$data$3a$d08d07__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["registerUser"])(formData);
        if (result.error) {
            alert(result.error);
            return;
        }
...
//# sourceMappingURL=richard_acc4c085._.js.map